...
**Never** `return true` on `bricks/code/echo_function_names` in production: that's the pre-1.9.7 RCE surface. See the `custom-code` skill for the full echo-tag threat model.
